  ...
  return (
    <div className="mt-auto flex flex-col gap-1 pb-4">
          ...
          <div className="mt-2 space-y-5 sm:mt-4 sm:space-y-6">
            <section>
              ...
              <p className="mt-1.5 text-sm leading-relaxed text-slate-600 sm:text-base">
                Se enviará un enlace seguro al correo electrónico registrado
            ...
            <section>
              <h3 className="text-lg font-semibold text-red-600 sm:text-xl">
                Eliminar cuenta
              </h3>
              <p className="mt-1.5 text-sm leading-relaxed text-slate-600 sm:text-base">
                Esta acción es irreversible. Resultará en la pérdida permanente
                de todos sus datos y configuraciones.
              </p>
              <Button
                variant="destructive"
                className="mt-4 w-full border-none bg-red-50 text-red-700 shadow-none hover:bg-red-100 sm:mt-5"
              >
                <Trash2 className="mr-2 size-4" /> Eliminar cuenta
                permanentemente
              </Button>
            </section>
          </div>
      ...
      <button
        ...
        className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-400 transition-colors hover:bg-red-50 hover:text-red-600"
      >
