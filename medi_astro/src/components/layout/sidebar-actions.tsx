      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[460px]">
          <div className="mt-4 space-y-6">
            <section>
              <h3 className="text-xl font-semibold">Restablecer contraseña</h3>
              <p className="mt-1.5 leading-relaxed text-slate-600">Se enviará un enlace seguro al correo electrónico registrado para actualizar su contraseña.</p>
              <Button className="mt-5 w-full bg-[#464BD8] hover:bg-[#3D41BC]">
                <RotateCcw className="mr-2 size-4" /> Restablecer contraseña
              </Button>
            </section>
            <div className="h-px w-full bg-slate-200" />
            <section>
              <h3 className="text-xl font-semibold text-red-600">Eliminar cuenta</h3>
              <p className="mt-1.5 leading-relaxed text-slate-600">Esta acción es irreversible. Resultará en la pérdida permanente de todos sus datos y configuraciones.</p>
              <Button variant="destructive" className="mt-5 w-full border-none bg-red-50 text-red-700 shadow-none hover:bg-red-100">
